...
class TestKMCParser(unittest.TestCase):
    def setUp(self):
        ...
        self.parser.register_metadata_handler("doc", lambda var: {
            "version": "1.0"
        }.get(var, f"<doc:{var}>"))
        
        self.parser.register_generative_handler("ai:gpt4", lambda name, prompt, format_type=None: 
...
<!-- KMC {{ai:gpt4:paso2}}:"Segundo paso usando {{ai:gpt4:paso1}}" -->"""
    ...
    def test_manejo_errores(self):
        ...
        self.parser.register_generative_handler("ai:error", 
